...
const contentClass = computed(() =>
  cn(
    'z-[200] max-h-96 min-w-[8rem] overflow-hidden rounded-xl border border-[#eee] dark:border-[#222] bg-white dark:bg-[#111] text-[#1a1a1a] dark:text-[#e5e5e5] shadow-lg pointer-events-auto',
