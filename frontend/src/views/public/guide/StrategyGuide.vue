    ...
    >
      ...
      <div class="overflow-hidden rounded-xl border border-[#eee] dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[#17171a] max-w-2xl">
        <table class="w-full text-sm text-left">
          ...
          <tbody class="divide-y divide-[#e5e6eb] dark:divide-[rgba(227,224,211,0.06)]">
            <tr class="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
              <td class="px-6 py-4 font-mono font-medium text-[#2a2a2b] dark:text-[#e5e5e5]">
                Base
              </td>
              <td class="px-6 py-4 text-[#4e5969] dark:text-[#a3a094]">
