    ...
    <template #sidebar>
      ...
      <div class="shrink-0 flex items-center px-6 h-20">
        ...
        >
          <HeaderLogo
            size="h-9 w-9"
            class-name="text-[#2a2a2b] dark:text-white"
          />
          <div class="flex flex-col justify-center">
            <h1 class="text-lg font-bold text-[#2a2a2b] dark:text-white leading-none">
              {{ siteName }}
            </h1>
      ...
      <!-- FOOTER (Base URL) -->
      <div class="p-4 border-t border-[#2a2a2b]/5 dark:border-white/5">
        ...
        <input
          v-model="baseUrl"
          type="text"
          class="w-full px-3 py-2 text-sm rounded-lg border border-[#2a2a2b]/5 dark:border-white/5 bg-white/50 dark:bg-white/5 text-[#2a2a2b] dark:text-white placeholder-[#999999] focus:outline-none focus:ring-2 focus:ring-[#2a2a2b]/30 transition"
...
const sidebarClasses = computed(() => {
  return 'w-[260px] flex flex-col hidden lg:flex border-r border-[#2a2a2b]/5 dark:border-white/5 bg-[#ffffff] dark:bg-[#232324] h-screen sticky top-0'
})

const contentClasses = computed(() => {
  return 'flex-1 min-w-0 bg-[#ffffff] dark:bg-[#17171a] text-[#2a2a2b] dark:text-[#e5e5e5]'
})
