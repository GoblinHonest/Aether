...
const contentClass = computed(() =>
  cn(
'z-[200] max-h-96 min-w-[var(--radix-select-trigger-width,8rem)] max-w-[min(calc(100vw-1rem),var(--radix-select-content-available-width,100vw))] overflow-hidden rounded-xl border border-[#eee] dark:border-[#222] bg-white dark:bg-[#111] text-[#1a1a1a] dark:text-[#e5e5e5] shadow-lg pointer-events-auto',
